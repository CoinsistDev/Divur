...
export const toDepartmentDetails = (Department) => {
    ...
    return {
        ...
        remainingMessages: Department.remainingMessages,
        remainingSMSMessages: Department.remainingSMSMessages,
        totalNonTicketSent: Department.messageLog.totalNonTicketSent,
        totalNonTicketMessageDelivered: Department.messageLog.totalNonTicketMessageDelivered,
        totalNonTicketMessageRead: Department.messageLog.totalNonTicketMessageRead,
        totalNonTicketMessageFailed: Department.messageLog.totalNonTicketMessageFailed,
        users,
